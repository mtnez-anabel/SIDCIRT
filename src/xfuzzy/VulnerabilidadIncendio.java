package xfuzzy;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++//
//     Fuzzy Inference Engine VulnerabilidadIncendio      //
//++++++++++++++++++++++++++++++++++++++++++++++++++++++//

public class VulnerabilidadIncendio implements FuzzyInferenceEngine {
 ...
 private class TP_typeGravIndiceFallec {
  ...
  double _p_Bajo[] = { 0.25,-0.01 };
  double _p_Medio[] = { 0.5,0.2 };
  double _p_Alto[] = { 0.75,0.01 };
  MF_xfl_sigma Bajo = new MF_xfl_sigma(min,max,step,_p_Bajo);
  MF_xfl_bell Medio = new MF_xfl_bell(min,max,step,_p_Medio);
  MF_xfl_sigma Alto = new MF_xfl_sigma(min,max,step,_p_Alto);
 }
 ...
 private class TP_typeVulnerabilidad {
  ...
  MF_xfl_sigma MuyAlta = new MF_xfl_sigma(min,max,step,_p_MuyAlta);
 }
 ...
 private MembershipFunction[] RL_Rule_Vulner(MembershipFunction inGravIndiceFallec, MembershipFunction inGravIndiceLesion, MembershipFunction inDInterMayores, MembershipFunction inDExterMayores, MembershipFunction inDMedioambiental) {
  ...
  outVulnerabilidad.set(9,_op,_input);
  ...
  _rl = _op.and(_op.and(_op.and(_op.and(_t_inGravIndiceFallec.Alto.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Bajo.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Bajo.isEqual(inDInterMayores)),_t_inDExterMayores.Bajo.isEqual(inDExterMayores)),_t_inDMedioambiental.Bajo.isEqual(inDMedioambiental));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Media); _i_outVulnerabilidad++;
  _rl = _op.and(_op.and(_op.and(_op.and(_t_inGravIndiceFallec.Bajo.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Medio.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Medio.isEqual(inDInterMayores)),_t_inDExterMayores.Medio.isEqual(inDExterMayores)),_t_inDMedioambiental.Medio.isEqual(inDMedioambiental));
  ...
  _rl = _op.and(_op.and(_op.and(_op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Medio.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Alto.isEqual(inDInterMayores)),_t_inDExterMayores.Alto.isEqual(inDExterMayores)),_t_inDMedioambiental.Alto.isEqual(inDMedioambiental));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Alta); _i_outVulnerabilidad++;
  _rl = _op.and(_op.and(_op.and(_op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Medio.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Medio.isEqual(inDInterMayores)),_t_inDExterMayores.Alto.isEqual(inDExterMayores)),_t_inDMedioambiental.Alto.isEqual(inDMedioambiental));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Alta); _i_outVulnerabilidad++;
  _rl = _op.and(_op.and(_op.and(_op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Medio.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Medio.isEqual(inDInterMayores)),_t_inDExterMayores.Medio.isEqual(inDExterMayores)),_t_inDMedioambiental.Medio.isEqual(inDMedioambiental));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Media); _i_outVulnerabilidad++;
  _rl = _op.and(_op.and(_op.and(_t_inGravIndiceFallec.Bajo.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Bajo.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Bajo.isEqual(inDInterMayores)),_op.or(_op.and(_t_inDExterMayores.Medio.isEqual(inDExterMayores),_t_inDMedioambiental.Medio.isEqual(inDMedioambiental)),_op.and(_t_inDExterMayores.Alto.isEqual(inDExterMayores),_t_inDMedioambiental.Alto.isEqual(inDMedioambiental))));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Baja); _i_outVulnerabilidad++;
  _rl = _op.and(_op.and(_op.and(_op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Medio.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Bajo.isEqual(inDInterMayores)),_t_inDExterMayores.Bajo.isEqual(inDExterMayores)),_t_inDMedioambiental.Bajo.isEqual(inDMedioambiental));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Media); _i_outVulnerabilidad++;
