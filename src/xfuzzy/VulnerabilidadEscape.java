package xfuzzy;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++//
//     Fuzzy Inference Engine VulnerabilidadEscape      //
//++++++++++++++++++++++++++++++++++++++++++++++++++++++//

public class VulnerabilidadEscape implements FuzzyInferenceEngine {
 ...
 private MembershipFunction[] RL_Rule_Vulner(MembershipFunction inGravIndiceFallec, MembershipFunction inGravIndiceLesion, MembershipFunction inDInterMayores, MembershipFunction inDExterMayores, MembershipFunction inDMedioambiental) {
  ...
  _rl = _op.and(_t_inGravIndiceFallec.Alto.isEqual(inGravIndiceFallec),_op.and(_t_inDInterMayores.Alto.isEqual(inDInterMayores),_op.and(_t_inDExterMayores.Alto.isEqual(inDExterMayores),_t_inDMedioambiental.Alto.isEqual(inDMedioambiental))));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.MuyAlta); _i_outVulnerabilidad++;
  _rl = _op.and(_t_inGravIndiceFallec.Alto.isEqual(inGravIndiceFallec),_op.and(_t_inGravIndiceLesion.Medio.isEqual(inGravIndiceLesion),_t_inDMedioambiental.Medio.isEqual(inDMedioambiental)));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Alta); _i_outVulnerabilidad++;
  _rl = _op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_op.and(_t_inGravIndiceLesion.Alto.isEqual(inGravIndiceLesion),_t_inDMedioambiental.Alto.isEqual(inDMedioambiental)));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Alta); _i_outVulnerabilidad++;
  _rl = _op.and(_t_inGravIndiceFallec.Bajo.isEqual(inGravIndiceFallec),_op.and(_t_inGravIndiceLesion.Alto.isEqual(inGravIndiceLesion),_t_inDMedioambiental.Alto.isEqual(inDMedioambiental)));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Media); _i_outVulnerabilidad++;
  _rl = _op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_op.and(_t_inGravIndiceLesion.Alto.isEqual(inGravIndiceLesion),_t_inDMedioambiental.Medio.isEqual(inDMedioambiental)));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Media); _i_outVulnerabilidad++;
  _rl = _op.and(_t_inGravIndiceFallec.Bajo.isEqual(inGravIndiceFallec),_op.and(_t_inGravIndiceLesion.Bajo.isEqual(inGravIndiceLesion),_op.and(_t_inDInterMayores.Medio.isEqual(inDInterMayores),_op.and(_t_inDExterMayores.Medio.isEqual(inDExterMayores),_t_inDMedioambiental.Bajo.isEqual(inDMedioambiental)))));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Baja); _i_outVulnerabilidad++;
  _rl = _op.and(_t_inGravIndiceFallec.Bajo.isEqual(inGravIndiceFallec),_op.and(_t_inGravIndiceLesion.Bajo.isEqual(inGravIndiceLesion),_op.and(_t_inDInterMayores.Bajo.isEqual(inDInterMayores),_op.and(_t_inDExterMayores.Bajo.isEqual(inDExterMayores),_t_inDMedioambiental.Bajo.isEqual(inDMedioambiental)))));
