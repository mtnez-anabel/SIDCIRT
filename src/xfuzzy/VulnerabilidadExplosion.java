package xfuzzy;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++//
//     Fuzzy Inference Engine VulnerabilidadExplosion      //
//++++++++++++++++++++++++++++++++++++++++++++++++++++++//

public class VulnerabilidadExplosion implements FuzzyInferenceEngine {
 ...
 private MembershipFunction[] RL_Rule_Vulner(MembershipFunction inGravIndiceFallec, MembershipFunction inGravIndiceLesion, MembershipFunction inDInterMayores, MembershipFunction inDExterMayores, MembershipFunction inDMedioambiental) {
  ...
  _rl = _t_inGravIndiceFallec.Alto.isEqual(inGravIndiceFallec);
  ...
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.MuyAlta); _i_outVulnerabilidad++;
  _rl = _op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Alto.isEqual(inGravIndiceLesion));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.MuyAlta); _i_outVulnerabilidad++;
  ...
  _rl = _op.and(_op.and(_t_inGravIndiceFallec.Bajo.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Bajo.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Medio.isEqual(inDInterMayores));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Baja); _i_outVulnerabilidad++;
  _rl = _op.and(_op.and(_op.and(_op.and(_t_inGravIndiceFallec.Medio.isEqual(inGravIndiceFallec),_t_inGravIndiceLesion.Bajo.isEqual(inGravIndiceLesion)),_t_inDInterMayores.Bajo.isEqual(inDInterMayores)),_t_inDExterMayores.Bajo.isEqual(inDExterMayores)),_t_inDMedioambiental.Bajo.isEqual(inDMedioambiental));
  outVulnerabilidad.set(_i_outVulnerabilidad,_rl, _t_outVulnerabilidad.Media); _i_outVulnerabilidad++;
